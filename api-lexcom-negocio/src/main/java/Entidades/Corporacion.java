...
public class Corporacion implements Serializable {
    ...
    public Corporacion(Long id_corporacion, String nombre, Long activo, String descripcion, Calendar fecha_hora_modificacion, String usuario_modificacion) {
    ...
    public String toString() {
        return "Corporacion{" + "id_corporacion=" + id_corporacion + ", nombre=" + nombre + ", activo=" + activo + ", descripcion=" + descripcion + ", fecha_hora_modificacion=" + fecha_hora_modificacion + ", usuario_modificacion=" + usuario_modificacion + '}';
    }
