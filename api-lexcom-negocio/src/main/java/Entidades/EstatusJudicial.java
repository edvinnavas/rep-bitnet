...
public class EstatusJudicial implements Serializable {
    ...
    public EstatusJudicial(Long id_estatus_judicial, EstadoJudicial estado_judicial, String nombre, Long activo, String descripcion, Calendar fecha_hora_modificacion, String usuario_modificacion) {
    ...
    public String toString() {
        return "EstatusJudicial{" + "id_estatus_judicial=" + id_estatus_judicial + ", estado_judicial=" + estado_judicial + ", nombre=" + nombre + ", activo=" + activo + ", descripcion=" + descripcion + ", fecha_hora_modificacion=" + fecha_hora_modificacion + ", usuario_modificacion=" + usuario_modificacion + '}';
    }
