...
public class BitacoraGestionJuridico implements Serializable {
    ...
    public BitacoraGestionJuridico(Long id_corporacion, Long id_actor, Long id_deudor, Long numero_caso, CodigoResultado codigo_resultado, Calendar fecha_hora, String usuario_gestion, String descripcion_gestion, Calendar fecha_hora_modificacion, String usuario_modificacion) {
