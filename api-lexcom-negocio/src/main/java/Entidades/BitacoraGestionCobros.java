...
public class BitacoraGestionCobros implements Serializable {
    ...
    private Long id_bitacora_gestion_cobros;
    ...
    public BitacoraGestionCobros(Long id_bitacora_gestion_cobros, Long id_expediente, CodigoResultado codigo_resultado, Calendar fecha_hora, String usuario_gestion, String descripcion_gestion, Calendar fecha_hora_modificacion, String usuario_modificacion) {
        this.id_bitacora_gestion_cobros = id_bitacora_gestion_cobros;
    ...
    public Long getId_bitacora_gestion_cobros() {
        return id_bitacora_gestion_cobros;
    }

    public void setId_bitacora_gestion_cobros(Long id_bitacora_gestion_cobros) {
        this.id_bitacora_gestion_cobros = id_bitacora_gestion_cobros;
    }
    ...
    public String toString() {
        return "BitacoraGestionCobros{" + "id_bitacora_gestion_cobros=" + id_bitacora_gestion_cobros + ", id_expediente=" + id_expediente + ", codigo_resultado=" + codigo_resultado + ", fecha_hora=" + fecha_hora + ", usuario_gestion=" + usuario_gestion + ", descripcion_gestion=" + descripcion_gestion + ", fecha_hora_modificacion=" + fecha_hora_modificacion + ", usuario_modificacion=" + usuario_modificacion + '}';
    }
